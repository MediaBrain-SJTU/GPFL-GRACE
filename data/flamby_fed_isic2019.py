    ...
    def __init__(
        ...
        self.dic = {
            ...
            "train_test_split": os.path.join(
                dir, "metadata/isic2019_train_test_split"
            ),
        }
...
if __name__ == "__main__":
    ...
    data_path = isic2019_path
    mydataset = Isic2019Raw(data_path=data_path)
    ...
    mydataset = FedIsic2019(data_path=data_path, train=True, pooled=True)
    print(len(mydataset))
    print("Size of image 0 ", mydataset[0][0].shape)
    mydataset = FedIsic2019(data_path=data_path, train=False, pooled=True)
    print(len(mydataset))
    print("Size of image 0 ", mydataset[0][0].shape)

    for i in range(6):
        mydataset = FedIsic2019(data_path=data_path, center=i, train=True, pooled=False)
        print(f'Site {i} train ' ,len(mydataset), Counter(mydataset.targets))
        # print("Size of image 0 ", mydataset[0][0].shape)
        mydataset = FedIsic2019(data_path=data_path, center=i, train=False, pooled=False)
        print(f'Site {i} test ' ,len(mydataset), Counter(mydataset.targets))
        # print("Size of image 0 ", mydataset[0][0].shape)

    mydataset = FedIsic2019(data_path=data_path, center=5, train=False, pooled=False)
    print(len(mydataset))
    for i in range(11):
        print(f"Size of image {i} ", mydataset[i][0].shape)
